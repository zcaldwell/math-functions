...
export function sumAndMultiplyThreeNumbers(a, b, c) { //eslint-disable-line
    ...
    const str1 = `${a} and ${b} and ${c} sum to ${sumOf3}.`; 
    const str2 = `The product of ${a} and ${b} and ${c} is ${multOf3}.`;
    return [sumOf3, multOf3, str1, str2];
...
export function sumArrayWithThreeNumbers(sumArr) {
    const sumAr = [2, 3, 4];
    const sum3 = sum(sumAr[0], sumAr[1])[0];
    const sum4 = sum(sum3, sumAr[2])[0];
    const str = `${sumAr[0]},${sumAr[1]},${sumAr[2]} was passed in as an array of numbers, and ${sum4} is their sum.`;
    return [sum4, str];
}
...
export function multiplyArrayWithThreeNumbers(multArr) { //eslint-disable-line
    const multAr = [2, 3, 4];
    const mult3 = multiply(multAr[0], multAr[1])[0];
    const mult4 = multiply(mult3, multAr[2])[0];
    const str = `The numbers ${multAr[0]},${multAr[1]},${multAr[2]} have a product of ${mult4}.`;
    return [mult4, str];
}
...
export function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    ...
    const str = `The numbers 1,2,3,4,5 have a product of ${product}.`;     
    return [product, str];
}
//     const mult1 = multiply(multAr[0], multAr[1])[0];
//     const mult2 = multiply(mult1, multAr[2])[0];
//     const mult3 = multiply(mult2, multAr[3])[0];
//     const mult4 = multiply(mult3, multAr[4])[0];
//     const str = `The numbers ${multAr[0]},${multAr[1]},${multAr[2]},${multAr[3]},${multAr[4]} have a product of ${mult4}.`;
//     return [mult4, str];
// }
